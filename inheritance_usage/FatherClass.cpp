...
namespace gitee::com::ivfzhou::cpp {
    ...
    void FatherClass::virtualMethod() { std::cout << "FatherClass::virtualMethod " << publicField << std::endl; }
    ...
    void FatherClass::staticMethod() { std::cout << "FatherClass::staticMethod " << std::endl; }

    FatherClass::~FatherClass() { std::cout << "~FatherClass " << std::endl; }
}
